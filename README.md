...
# Git Practice: [Абдулаев Билолидин]
...
| Поле             | Значение                                |
|------------------|-----------------------------------------|
| ФИО              | [Абдулаев Билолидин]                           |
| Группа           | [РПО-2]                                |
| Дисциплина       | Git и GitHub                            |
| Дата выполнения  | [17.06.2026]                            |
| Ссылка на GitHub | [https://github.com/bililgit/kontrol_git_rpo]                   |
...
Конфликты возникают из-за одновременного изменения файла, решают их либо применением одного из изменений либо их объединения
...
Мы научились пользоваться git и github. Также закрепили слияние веток и сами ветки
